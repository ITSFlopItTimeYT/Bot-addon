...
exports.run = (client, msg, args, content, cooldown, command, Discord, config, request) => {
    ...
    var banTime = new Date().toLocaleString("en-US", {timeZone: "America/Chicago", timeZoneName: "short", weekday: "short", month: "long", day: "2-digit", year: "numeric", hour: '2-digit', minute:'2-digit'});
    ...
    //        msg.channel.send("I'm sorry but you may not ban this person");
        ...
        msg.channel.send("The required syntax is `E ban @user [reason]`")
    } else {
